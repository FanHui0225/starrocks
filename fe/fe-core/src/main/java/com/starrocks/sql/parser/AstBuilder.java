...
public class AstBuilder extends StarRocksBaseVisitor<ParseNode> {
    ...
    @Override
    public ParseNode visitSetResourceIsolation(StarRocksParser.SetResourceIsolationContext context) {
        NodePosition pos = createPos(context);
        List<String> hosts = new ArrayList<>();
        UserIdentity userIdentity = (UserIdentity) visit(context.user());
